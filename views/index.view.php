    ...
    <footer>
        <section class="footer-1">
                <div class="about-1">
                        ...
                        <p><a href="about.php">Live Traffic with Tom Tom API</a></p>
                        <p><a href="about.php">Discussion Chat with Rumbletalk</a></p>
                </div>
                <div>
                    <section id="contact">
                ...
                <div class="social-links">
                        ...
                        <a href="https://www.twitter.com/yourDriverConnectPage" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
