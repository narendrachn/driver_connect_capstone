...
var centerCoords = [235.005, 49.6841];
var initialZoom = 13;
var map = tt.map({
    key: apiKey,
    container: "map",
...
const notification = document.getElementById("notification").addEventListener('click', () =>{
    Notification.requestPermission().then(prem=> {
        if (prem = "granted"){
            new Notification("traffic is heavy",{
                body: "Please be cautious of heavy traffic",
            })
        }
